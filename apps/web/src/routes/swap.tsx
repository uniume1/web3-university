...
const TOKENS = {
	UNI: {
		address: addresses[CHAIN_ID].uniToken,
		symbol: "UNI",
		decimals: 18,
		name: "UNIToken",
	},
	...
	return (
		<main className="container mx-auto max-w-md px-4 py-8">
			<div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
				<h1 className="mb-6 font-bold text-2xl">兑换</h1>

				{/* 代币输入 */}
				<div className="mb-4 rounded-lg bg-gray-50 p-4">
					<div className="flex items-center justify-between">
						<span className="text-gray-500 text-sm">卖出</span>
				...
				<div className="mb-4 rounded-lg bg-gray-50 p-4">
					<div className="flex items-center justify-between">
						<span className="text-gray-500 text-sm">买入</span>
						<span className="text-gray-500 text-sm">
				...
				{state === "success" && txHash && (
					<div className="mb-4 rounded-lg bg-green-50 p-3 text-green-600 text-sm">
						✅ 兑换成功！
						<a
...
function TokenSelect({
	...
	return (
		<select
			...
			className="rounded-lg border border-gray-200 bg-white px-3 py-2 font-medium text-sm"
		>
			{tokens
				.filter((t) => t !== exclude)
				.map((key) => (
